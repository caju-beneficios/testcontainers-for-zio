import sbt.Def
import sbtghpackages.GitHubPackagesPlugin.autoImport.{TokenSource, githubTokenSource}
...
object GithubPackages {
  ...
  val tokenResolutionSource: Def.Setting[TokenSource] =
    githubTokenSource := TokenSource.Environment("GITHUB_TOKEN") || TokenSource.GitConfig("user.token")
